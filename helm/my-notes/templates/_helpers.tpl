...
helm.sh/chart: {{ include "my-notes.chart" . }}
...
*/}}
{{- define "my-notes.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "my-notes.fullname" .) .Values.serviceAccount.name }}
{{- else }}
